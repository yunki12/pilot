...
@Slf4j
public class CommonCodeTableManager {
	@SuppressWarnings ("rawtypes")
	public static LinkedHashMap mCmmnCodeTables;
	private static CommonCodeTableManager mInstance;

	@SuppressWarnings ("rawtypes")
	public CommonCodeTableManager() {
		// 코드테이블생성
	 ...
	 * @return
	 */
	public static CommonCodeTableManager getInstance() {

	if (mInstance == null) {
			log.debug("mCmmnCodeTables is null");
			mInstance = new CommonCodeTableManager();
